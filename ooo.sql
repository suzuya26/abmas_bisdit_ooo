...
INSERT INTO `toko_oleh` (`idtoko`, `nama_toko`, `gambar_utama`, `map_toko`, `jam_operasional`, `fasilitas_toko`, `jenis_sekitar`, `kontak_toko`, `galeri_toko`, `created_at`, `updated_at`, `value_jenis_sekitar`, `galeri_toko_caption`, `rekomendasi_count`) VALUES
