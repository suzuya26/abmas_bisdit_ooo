...
(9, 'daffa', 'Lumajang', NULL, NULL, NULL, NULL, NULL, '085456623', 'www.spikoe.com', '@spikoekoe', NULL, NULL, NULL, '', '', '', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `toko_oleh` (`idtoko`, `nama_toko`, `gambar_utama`, `map_toko`, `jam_operasional`, `fasilitas_toko`, `jenis_sekitar`, `kontak_toko`, `galeri_toko`, `created_at`, `updated_at`, `value_jenis_sekitar`, `galeri_toko_caption`, `rekomendasi_count`, `jam_buka`) VALUES
(1, 'Spikoe Surabaya', 'assa', 'assas', '10.00-16.00', 'Parkir Mobil & Motor---Wifi Gratis---Pesan Antar---Pembayaran Non-Tunai---Makan di Tempat', 'ATM BCA---50M---Bandara Juanda---10.3KM', 'www.spikoekuno.co.id---081234567890---@spikoekunosby---@spikoekunosby', 'https://i0.wp.com/www.emporioarchitect.com/upload/portofolio/1280/desain-rumah-dan-toko-modern-2-lantai-43010721-94431946010721023307-3.jpg---https://i0.wp.com/www.emporioarchitect.com/upload/portofolio/thumb/desain-rumah-dan-toko-modern-2-lantai-43010721-94431946010721023307-5.jpg---https://i0.wp.com/www.emporioarchitect.com/upload/portofolio/1280/desain-rumah-dan-toko-modern-2-lantai-43010721-94431946010721023307-3.jpg', NULL, NULL, '', 'Tampak Depan Toko---Jalan Tunjungan Plaza 78, Tunjungan, Plaza---Tampak Samping Toko---Jalan Tunjungan Plaza 78, Tunjungan, Plaza---Tampak Belakang Toko---Jalan Tunjungan Plaza 78, Tunjungan, Plaza', NULL, '');
...
(9, 'daffa123', 'daffa123@gmail.com', NULL, '$2y$10$7emLFBVEjrfpu3T8I/.ZpekcKl/Wbm5ZQ8YS/dejZuUNlQEitoIpW', 'https://ui-avatars.com/api/?name=daffa123&background=7F9CF5&color=EBF4FF', NULL, '2022-06-05 04:48:50', '2022-06-05 04:48:50', NULL, 1, NULL);
...
--
ALTER TABLE `rekomendasi`
  MODIFY `idrekomendasi` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rekomendasioleh`
--
ALTER TABLE `rekomendasioleh`
  MODIFY `idrekomendasioleh` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
