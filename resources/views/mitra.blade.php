    ...
    <div class="body" style="overflow:hidden">
            ...
            <div class="container">
                <div class="row Rectangle-bg">
                        ...
                        <div class="row ">
                            ...
                            <div class="row rekom mt-3">
                                <div class="col-6">
                                    ...
                                    {{-- <livewire:rekomendasi-index :idmitra="$idmitra"></livewire:rekomendasi-index> --}}

                                </div>
                                <div class="col-6">
                                    <p>Ingin kunjungi toko ini?</p>
                                    {{-- <livewire:list-toko-index :idmitra="$idmitra"></livewire:list-toko-index> --}}
                    ...
                    <div class="col-6 mt-3">
                        <div class="foto-oleh">
                            <img src="{{ asset('data_file/') }}/{{$toko->gambar_utama}}" width="785px" height="575px" >
        ...
        <section id="tempatbeli" style="margin-bottom: 200px;margin-top:-30px">
            <div class="container">
                ...
                <div class="row" >
                    @foreach ($produk_mitra as $t)
                    <div class="caro col-3">
                        <div class="foto-beli">
                            <img src="{{ asset('data_file/') }}/{{$t->gambar_produkMitra}}" width= "301px"
        ...
        <div class="container" style="">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="row">
                        @php
                            $sekita_mitra = preg_split('/---/', $toko->sekitar_mitra);
                        @endphp
                        @foreach ($sekita_mitra as $s)
                            @if ($loop->odd)
                                <div class="col-5">
                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <i class='fas fa-globe'></i> <a href="{{ $toko->website_mitra }}" style="color: black;text-decoration:none">{{ $toko->website_mitra }}</a>
                            </div>
                            @endif
